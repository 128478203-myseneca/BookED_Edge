...
class Profile(models.Model):
    ...
    school = models.ForeignKey(main.models.School, on_delete=models.CASCADE)
    course = models.ForeignKey(main.models.Course, blank= True, on_delete=models.SET_NULL, null=True)
    classes = models.ForeignKey(main.models.Class, blank= True, on_delete=models.SET_NULL, null=True)
    semester = models.ForeignKey(main.models.Semester, blank= True, on_delete=models.SET_NULL, null=True)
